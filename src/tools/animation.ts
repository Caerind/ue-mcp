...
export const animationTool: ToolDef = categoryTool(
  ...
  {
    read_anim_blueprint:  ro(bp("Read AnimBP structure. Params: assetPath", "read_anim_blueprint")),
    read_montage:         ro(bp("Read montage. Params: assetPath", "read_anim_montage", (p) => ({ assetPath: p.assetPath }))),
    read_sequence:        ro(bp("Read anim sequence. Params: assetPath", "read_anim_sequence", (p) => ({ assetPath: p.assetPath }))),
    read_blendspace:      ro(bp("Read blendspace. Params: assetPath", "read_blendspace", (p) => ({ assetPath: p.assetPath }))),
    list:                 ro(bp("List anim assets. Params: directory?, recursive?", "list_anim_assets")),
    ...
    get_skeleton_info:    ro(bp("Read skeleton. Params: assetPath", "get_skeleton_info")),
    list_sockets:         ro(bp("List sockets. Params: assetPath", "list_sockets")),
    list_skeletal_meshes: ro(bp("List skeletal meshes. Params: directory?, recursive?", "list_skeletal_meshes")),
    get_physics_asset:    ro(bp("Read physics asset. Params: assetPath", "get_physics_asset_info")),
    ...
    get_bone_transforms:  ro(bp("Read reference pose transforms. Params: skeletonPath, boneNames?", "get_bone_transforms")),
    ...
    read_state_machine:   ro(bp("Read state machine topology. Params: assetPath, stateMachineName", "read_state_machine")),
    read_anim_graph:      ro(bp("Read AnimBP AnimGraph nodes with properties & pins. Params: assetPath, graphName?", "read_anim_graph")),
    ...
    read_ik_rig:          ro(bp("Read IK Rig chains, solvers, skeleton. Params: assetPath", "read_ik_rig")),
    list_control_rig_variables: ro(bp("List ControlRig variables and hierarchy. Params: assetPath", "list_control_rig_variables")),
    ...
    list_modifiers:     ro(bp("List applied animation modifiers. Params: assetPath", "list_anim_modifiers", (p) => ({ path: p.assetPath }))),
    ...
    read_ik_retargeter: ro(bp("Read IKRetargeter: source/target rigs and chain mappings. Params: assetPath (#246)", "read_ik_retargeter", (p) => ({ assetPath: p.assetPath }))),
    set_anim_blueprint_skeleton: bp("Set target skeleton on AnimBP. Params: assetPath, skeletonPath", "set_anim_blueprint_skeleton"),
    read_bone_track:    ro(bp("Read bone transform samples from AnimSequence. Params: assetPath, boneName, frames?: [int]", "read_bone_track")),
    ...
    read_pose_search_database:   ro(bp("Inspect a PoseSearchDatabase: schema, animation entries, cost biases, tags. Params: assetPath", "read_pose_search_database", (p) => ({ assetPath: p.assetPath }))),
