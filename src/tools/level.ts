...
export const levelTool: ToolDef = categoryTool(
  ...
  {
    get_outliner:       ro(bp("List actors. Params: classFilter?, nameFilter?, world? (editor|pie|auto), limit?", "get_world_outliner")),
    ...
    get_actor_details:  ro(bp("Inspect actor. Params: actorLabel OR actorPath, includeProperties?, propertyName?, world? (editor|pie)", "get_actor_details")),
    ...
    get_selected:       ro(bp("Get selection", "get_selected_actors")),
    ...
    get_current:        ro(bp("Get current level name and path", "get_current_level")),
    load:               bp("Load level. Params: levelPath", "load_level"),
    save:               bp("Save current level", "save_current_level"),
    list:               ro(bp("List levels. Params: directory?, recursive?", "list_levels")),
    ...
    list_volumes:       ro(bp("List volumes. Params: volumeType?", "list_volumes")),
    ...
    get_actors_by_class: ro(bp("List actors by class name. Params: className, world? (editor|pie)", "get_actors_by_class")),
    count_actors_by_class: ro(bp("Histogram of actor classes in the level (sorted desc). Params: world? (editor|pie), topN? (#146)", "count_actors_by_class", (p) => ({ world: p.world, topN: p.topN }))),
    get_runtime_virtual_texture_summary: ro(bp("List RuntimeVirtualTextureVolume actors + their bound VirtualTexture assets (#150)", "get_runtime_virtual_texture_summary")),
    ...
    get_spline_info:    ro(bp("Read spline. Params: actorLabel", "get_spline_info")),
    ...
    get_world_settings: ro(bp("Read world settings (GameMode, KillZ, gravity, etc.)", "get_world_settings")),
    ...
    get_actor_bounds:   ro(bp("Get actor AABB. Params: actorLabel. Returns origin + extent (#188)", "get_actor_bounds")),
    resolve_actor:      ro(bp("Resolve internal/runtime actor name to editor label. Params: internalName (e.g. StaticMeshActor_141). Returns actorLabel, actorPath, className, location (#178)", "resolve_actor")),
    ...
    list_actor_tags: ro(bp("List an actor's Tags. Params: actorLabel (#219)", "list_actor_tags", (p) => ({ actorLabel: p.actorLabel }))),
    ...
    get_current_edit_level: ro(bp("Read the active edit-target sub-level (#204)", "get_current_edit_level")),
    ...
    list_streaming_sublevels: ro(bp("List streaming sub-levels with transform + initially-loaded/visible flags (#206)", "list_streaming_sublevels")),
