import { z } from "zod";
import { categoryTool, bp, ro, type ActionSpec, type ToolDef } from "../types.js";
...
export const niagaraTool: ToolDef = categoryTool(
  ...
  {
    list:           ro(bp("List Niagara assets. Params: directory?, recursive?", "list_niagara_systems")),
    get_info:       ro(bp("Inspect system. Params: assetPath", "get_niagara_info")),
    ...
    list_emitters:  ro(bp("List emitters in system. Params: systemPath", "list_emitters_in_system")),
    set_emitter_property: bp("Set emitter property. Params: systemPath, emitterName?, propertyName, value", "set_emitter_property"),
    list_modules:   ro(bp("List Niagara modules. Params: directory?", "list_niagara_modules")),
    get_emitter_info: ro(bp("Inspect emitter. Params: assetPath", "get_emitter_info")),
    list_renderers:   ro(bp("List renderers on an emitter. Params: systemPath, emitterName?, emitterIndex?", "list_emitter_renderers")),
    ...
    inspect_data_interfaces: ro(bp("List user-scope data interfaces. Params: systemPath", "inspect_data_interface")),
    ...
    get_compiled_hlsl: ro(bp("Read GPU compute script info for an emitter. Params: systemPath, emitterName?, emitterIndex?", "get_niagara_compiled_hlsl")),
    list_system_parameters: ro(bp("List user-exposed system parameters. Params: systemPath", "list_niagara_system_parameters")),
    list_module_inputs:  ro(bp("List modules + their input pins for an emitter. Params: systemPath, emitterName?, emitterIndex?, stackContext? (ParticleSpawn|ParticleUpdate|EmitterSpawn|EmitterUpdate|all — default all)", "list_niagara_module_inputs")),
    ...
    list_static_switches: ro(bp("List static switch inputs on a module. Params: systemPath, moduleName, emitterName?, emitterIndex?, stackContext?", "list_niagara_static_switches")),
